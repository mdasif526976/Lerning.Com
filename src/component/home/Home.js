    ...
    return (
      ...
      <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
        <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          <p className="inline-block px-3 italic py-px mb-4 text-5xl font-semibold tracking-wider text-green-500 bg-teal-accent-400">
            Welcome to
          </p>
          <h2 className="mb-5 font-sans italic text-3xl font-bold tracking-tight text-green-500 sm:text-4xl sm:leading-none">
            Lerning.Com
