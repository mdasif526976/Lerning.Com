...
const SignUp = () => {
    const {signup,setNewuser,updateUser,googleSignIn,githubSign} = useContext(AuthContext)
    ...
    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
      <div className="card-body">
        <div className="form-control">
          ...
          <input type="text" onChange={getUserData} name='name' value={user.name} placeholder="Enter your Full Name" className="input input-bordered" />
        </div>
        <div className="form-control">
          <label className="label">
            <span className="label-text">Image Url</span>
          </label>
          <input type="text" onChange={getUserData} name='img' value={user.img} placeholder="Enter your image url" className="input input-bordered" />
        </div>
        <div className="form-control">
          <label className="label">
            <span className="label-text">Email</span>
          </label>
          <input type="Enter your email" onChange={getUserData} name='email' value={user.email} placeholder="email" className="input input-bordered" />
        </div>
        <div className="form-control">
          <label className="label">
